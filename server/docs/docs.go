...
const docTemplate = `{
    ...
    "paths": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.MetricOperatorVO"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.DataMetricVO"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.TaskGroupVO"
                                            }
                                        }
                                    }
                                }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/data.PublishStatusVO"
                        }
                    }
                ],
                "responses": {
        ...
        "/task-ms/v1/admin/tasks/task_group/{task_group_id}/users/{user_id}": {
            "get": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/data.UserTaskProgressVO"
                                            }
                                        }
                                    }
                                }
        ...
        "/task-ms/v1/web/tasks/task_group/{task_group_id}": {
            "get": {
        ...
        "data.TaskVO": {
            ...
            "properties": {
                "conditions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/data.TaskConditionVO"
                    }
                },
                "end_time": {
                    "type": "string"
